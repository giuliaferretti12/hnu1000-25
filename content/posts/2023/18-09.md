...
1. Que signifie le terme « modèle » selon l’approche de Jean-Guy Meunier ?

2. Dans ces articles, Meunier différencies trois types de modèles : modèles _conceptuels_, modèles _matériels_ et models _formels_. Expliquez brièvement ces trois notions.

3. Selon Meunier (qui cite Soare), pourquoi on peut dire que le machines numériques ne sont pas des machines de Turing ?

4. Selon Meunier (qui cite Soare), qu'est-ce que un oracle ?

5. Comment Meunier explique-t-il l'affirmation de Willard McCarty selon laquelle « Computers are essentially modeling machines, not knowledge jukeboxes » ?